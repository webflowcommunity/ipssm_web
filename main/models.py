...
class Gallery(models.Model):
    img = models.ImageField(("Gallery"), upload_to='static/gallery')


class Faculty(models.Model):
    name = models.CharField(("Name"), max_length=50)
    img = models.ImageField(("Faculty image"), upload_to='static/faculty')
...
class Event(models.Model):
    ...
    img = models.ImageField(("image"), upload_to="static/events")
...
class placements(models.Model):
    img = models.ImageField(("image"), upload_to="static/placements")


class studentachi(models.Model):
    name = models.CharField(("Name"), max_length=50)
    file = models.FileField(("PDF"), upload_to='static/studentpdf', max_length=100)
...
class testmonials(models.Model):
    ...
    img = models.ImageField(("image"), upload_to='static/testmonial')
    def __str__(self):
        return self.name
